...
class MedicalPostConsolidator(PostConsolidatorRule):
    ...
    def __init__(self):
        ...
        """
        super().__init__(supported_entity_types=["DISEASE", "MEDICATION", "MEDICAL_TEST","BODY_PARTS","CAMONI_MED_TERMS","RCOG_MED_TERMS","GENS"],
                         lower_preference_entity_types=["PERS", "PER", "ORG", "FAC", "MISC__AFF","LOC", "ID"],
